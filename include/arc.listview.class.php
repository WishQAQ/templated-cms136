...
class ListView
{
    ...
    function GetPageListST($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($this->PageNo != 1)
        {
            $prepage.="<a class=\"fypage_str\" href='".str_replace("{page}",$prepagenum,$tnamerule)."'>上一页</a>\r\n";
            $indexpage="<a class=\"fypage_str\" href='".str_replace("{page}",1,$tnamerule)."'>首页</a>\r\n";
        }
        else
        {
            $indexpage="<a class=\"fypage_str\" href=''>首页</a>\r\n";
        }

        //下一页,未页的链接
        if($this->PageNo!=$totalpage && $totalpage>1)
        {
            $nextpage.="<a class=\"fypage_str\" href='".str_replace("{page}",$nextpagenum,$tnamerule)."'>下一页</a>\r\n";
            $endpage="<a class=\"fypage_str\" href='".str_replace("{page}",$totalpage,$tnamerule)."'>末页</a>\r\n";
        }
        else
        {
            $endpage="<a class=\"fypage_str\">末页</a>\r\n";
        }
        ...
        for($j;$j<=$total_list;$j++)
        {
            if($j==$this->PageNo)
            {
                $listdd.= "<span class=\"fypage_current\">$j</span>\r\n";
            }
            else
            {
    ...
    function GetPageListDM($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($this->PageNo != 1)
        {
            $prepage.="<a class=\"fypage_str\" href='".$purl."PageNo=$prepagenum'>上一页</a>\r\n";
            $indexpage="<a class=\"fypage_str\" href='".$purl."PageNo=1'>首页</a>\r\n";
        }
        else
        {
            $indexpage="<a class=\"fypage_str\" href=''>首页</a>\r\n";
        ...
        if($this->PageNo!=$totalpage && $totalpage>1)
        {
            $nextpage.="<a class=\"fypage_str\" href='".$purl."PageNo=$nextpagenum'>下一页</a>\r\n";
            $endpage="<a class=\"fypage_str\" href='".$purl."PageNo=$totalpage'>末页</a><\r\n";
        }
        else
        {
            $endpage="<a class=\"fypage_str\">末页</a>\r\n";
